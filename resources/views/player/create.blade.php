...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Register New Player') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/newplayer">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="coach" type="text" class="form-control @error('coach') is-invalid @enderror" name="coach" value="{{ old('coach') }}" required autocomplete="coach" autofocus>
